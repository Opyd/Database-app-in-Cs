...
namespace Database {
    ...
    public partial class Form1 : Form {
        ...
        public static string[] losowanie(int currentid) {
            Random rnd = new Random(Guid.NewGuid().GetHashCode());
            string[] wykonawcy = new string[] { "Abba", "Metallica", "Ich troje", "Kappa Band", "Chillwagon", "Karolak" };
            string[] tytuly = new string[] { "Woods", "Space Odyssey", "Wooden axe", "Dworfs", "Mullermilch good", "GMD" };
